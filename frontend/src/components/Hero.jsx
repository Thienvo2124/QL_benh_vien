...
const Hero = () => {
  return (
    <section className="relative w-full h-[400px] md:h-[500px] bg-blue-50 flex items-center justify-center overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#004e92]/90 to-[#004e92]/40" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center md:text-left flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Link to="/booking" className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:-translate-y-1">
              Đặt hẹn khám
            </Link>
            <Link to="/doctors" className="bg-white hover:bg-gray-100 text-[#004e92] font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:-translate-y-1">
              Tìm bác sĩ
            </Link>
          </div>
        </div>
