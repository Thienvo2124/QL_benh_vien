...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'model',
      text: 'Xin chào! Tôi là trợ lý AI của Bệnh viện Nhân Dân. Tôi có thể giúp gì cho bạn hôm nay?',
    },
  ]);
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      setMessages([
        ...newMessages,
        { role: 'model', text: 'Xin lỗi, tôi đang gặp trục trặc kỹ thuật. Vui lòng thử lại sau!' },
      ]);
    } finally {
      setIsLoading(false);
    }
