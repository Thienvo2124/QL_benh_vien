...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://ql-benh-vien.onrender.com'}/api/auth/login`, {
                method: 'POST',
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    type="email"
                                    required
                                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#004e92] focus:border-[#004e92] sm:text-sm"
                                    value={email}
