...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      ['Sinh hóa máu (glucose, lipid)', '250.000đ'],
  ...
  },
  {
    ...
    items: [
      ...
      ['Cấy ghép Implant (1 răng)', 'từ 15.000.000đ']
    ]
  },
  {
    name: 'Sản phụ khoa',
    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-blue-50 border-l-4 border-[#004e92] rounded-r-xl p-4 mb-8 text-sm text-gray-600 max-w-3xl">
          ⚠️ Bảng giá chỉ mang tính tham khảo. Chi phí thực tế phụ thuộc vào tình trạng bệnh.
        ...
        <div className="text-center mt-10">
          ...
          <Link
            to="/lien-he"
            className="inline-block bg-[#004e92] hover:bg-blue-800 text-white font-bold px-8 py-3 rounded-full transition-colors"
          >
            Liên hệ tư vấn
          </Link>
        </div>
